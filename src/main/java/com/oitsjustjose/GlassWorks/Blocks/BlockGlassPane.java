...
public class BlockGlassPane extends Block
{
    ...
    public IIcon getSideTextureIndex (IBlockAccess world, int x, int y, int z)
    {
    	int meta = world.getBlockMetadata(x, y, z);
    	switch(meta)
    	{
    	case 0:return OakTextures[11];
    	case 1:return SpruceTextures[11];
    	case 2:return BirchTextures[11];
    	case 3:return JungleTextures[11];
    	case 4:return AcaciaTextures[11];
    	case 5:return DarkOakTextures[11];
    	case 6:return ClearTextures[11];
    	default:return ClearTextures[11];
    	}
    }
